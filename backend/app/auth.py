...
require_subnets_read = require_permission("subnets:read")
require_subnets_write = require_permissions(["subnets:create", "subnets:update", "subnets:delete"])
require_satellite_scanners_read = require_permission("satellite_scanners:read")
require_satellite_scanners_write = require_permissions(["satellite_scanners:create", "satellite_scanners:update", "satellite_scanners:delete"])
require_satellite_scanners_use = require_permission("satellite_scanners:use")
