        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="text-center">
            <div className="text-sm text-gray-600 dark:text-gray-400">
              ...
              <p>Username: <code className="bg-gray-100 dark:bg-gray-800 px-1 rounded text-gray-900 dark:text-gray-100">admin</code></p>
              <p>Password: <code className="bg-gray-100 dark:bg-gray-800 px-1 rounded text-gray-900 dark:text-gray-100">admin123</code></p>
            </div>
          </div>
        </form>
      </div>
