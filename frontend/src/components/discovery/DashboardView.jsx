        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            >
              ...
              <span className="text-body font-medium">Start Scan</span>
            </Button>
            <Button
            ...
            >
              <span className="text-2xl">⚡</span>
              <span className="text-body font-medium">Quick Scan</span>
            </Button>
            <Button
            ...
            >
              <span className="text-2xl">🌐</span>
              <span className="text-body font-medium">LAN Discovery</span>
            </Button>
            <Button
            ...
            >
              <span className="text-2xl">📱</span>
              <span className="text-body font-medium">View Devices</span>
            </Button>
          </div>
        </CardContent>
      </Card>
